...
class BusinessController extends Controller
{
    ...
    public function index_data(Request $request)
    {
        ...
        return DataTables::of($business)
            ...
            ->addColumn('edit', function ($item) {
                $action = '';
                $action .= '<a href="/admin-dashboard/business/'.$item->id.'/edit" class="btn btn-xs btn-primary"><i class="fa fa-edit"></i></a>';
                return $action;
            })
    ...
    public function store(Request $request)
    {
        ...
        if ($request->file('image')){
            ...
            $uploads_folder =  getcwd() .'/images/business';
        ...
        return redirect()->action('dashboard\BusinessController@index');
    }
    ...
    public function edit($id)
    {
        ...
        return view('dashboard.business.edit',compact('item'));
    }
