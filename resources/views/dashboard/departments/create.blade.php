            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-10">
                        ...
                        @endif
                        {!! Form::open(['url' => 'admin-dashboard/departments','files' => true,'id'=>'form']) !!}
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class=" col-sm-11">
                                <textarea rows="4" cols="128" name="description" id="description"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class=" col-sm-11">
                              <textarea rows="4" cols="128" name="en_description" id="en_description"></textarea>
                            </div>
                        </div>
