            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-10">
                        ...
                        @endif
                            {!! Form::open(['url' => 'admin-dashboard/departments/'.$department->id,'files' => true,'id'=>'form']) !!}
                            <input type="hidden" name="_method" value="PUT">
                            @csrf
                            <div class="form-group row">
                            <label class="col-sm-1">{{__('main.name')}}</label>
                            <div class=" col-sm-11">
                                <input type="text" class="form-control" name="name" value="{!! $department->name !!}" placeholder="{{__('main.name')}}" required>
                            </div>
                        </div>
                            ...
                            <div class=" col-sm-11">
                                <input type="text" class="form-control" name="en_name" value="{!! $department->en_name !!}" placeholder="{{__('main.en_name')}}" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class=" col-sm-11">
                                    <img src="{!! asset('/images/departments/'.$department->image) !!}" width="262" height="150" class="image-responsive">
                                </div>
                            </div>
                            <div class="form-group row">
